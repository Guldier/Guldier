"""
Django settings for Guldier project.
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (BASE_DIR.joinpath('static'), BASE_DIR.joinpath('payments/static'))
STATICFILES_FINDERS = [
...
PRODUCT_NAME = 'Doładowanie konta'