...
def get_topups_invoice(obj):
    ...
    if invoice:
        if obj.payment_intent_status == 'succeeded':
...
class TopUpAdmin(admin.ModelAdmin):
    list_display = ['id', get_topups_invoice, 'date_created', 'date_updated', 'user', 'amount', 'payment_intent_status', 'currency', 'live_mode']
